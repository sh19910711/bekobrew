...
static struct string_map_t *find(struct string_map_t **, const char *, int);
static const struct string_map_t *const_find(const struct string_map_t **, const char *, int);
